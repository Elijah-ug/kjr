...
export const Staff = () => {
  return (
    <div>
        {/* Our Dedicated Team */}
              <section className="py-20 bg-linear-to-b from-green-50 to-blue-200">
                <div className="max-w-7xl mx-auto px-6 text-center">
                  <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-12">Meet Our Dedicated Team</h2>
